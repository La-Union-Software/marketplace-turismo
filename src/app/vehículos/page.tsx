...
import { Grid, List, Search, Filter, Car, Euro, Calendar } from 'lucide-react';
    ...
    const fetchPosts = async () => {
      try {
        ...
        const vehiculoPosts = allPosts.filter(post => 
          VEHICULO_CATEGORIES.includes(post.category) && 
          ...
          {error ? (
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <p className="text-gray-600 dark:text-gray-300">
                  Mostrando {filteredPosts.length} de {posts.length} vehículos
                </p>
              </div>
