...
import { Grid, List, Search, Filter, GraduationCap, Euro, Calendar } from 'lucide-react';
    ...
    const fetchPosts = async () => {
      try {
        ...
        const clasesPosts = allPosts.filter(post => 
          CLASES_CATEGORIES.includes(post.category) && 
      ...
      <div className="max-w-7xl mx-auto p-8">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Aprende nuevas habilidades con los mejores instructores
          </p>
        </motion.div>
          ...
          {error ? (
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <p className="text-gray-600 dark:text-gray-300">
                  Mostrando {filteredPosts.length} de {posts.length} clases
                </p>
              </div>
